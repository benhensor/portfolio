    ...
    return (
        ...
        <nav>
            ...
            <div className='nav-menu'>
                ...
                <NavLink to='journey' name='My Journey' activeLink={activeLink} onUpdateActiveLink={onUpdateActiveLink} />
            ...
            <div className='header-icons'>
                ...
                <a href='#connect'><button className='connect-button'><span>Let's Connect!</span></button></a>
                <a href='#connect'><img src={send} alt='Send' className='connect-icon' onClick={() => handleClick()}/></a>
            </div>
